const navItems = ["Summary", "Recently viewed", "Bids & offers", "Watchlist", "Purchases", "Saved feed", "Saved searches", "Saved sellers", "Selling", "My Garage", "My Collection", "Sizes", "PSA Vault"];
